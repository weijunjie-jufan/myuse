 ...
 * @Author: 魏俊杰
 * @CreateDate: 2018/5/16 18:08
 * @UpdateUser: 魏俊杰
 * @Version: 1.0
 * Copyright: Copyright (c) 2018
 */
public class ZXingCode {
    private static final int QRCOLOR = 0xFF268A9A; // 默认是黑色
    ...
    public static void main(String[] args) throws WriterException {
        File logoFile = new File("D:\\testFile\\log3.png");
        File QrCodeFile = new File("D:\\testFile\\05.png");
